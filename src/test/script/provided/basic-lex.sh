...
if test_lex src/test/deca/syntax/lexer/provided/simple_lex.deca 2>&1 |
    head -n 1 | grep -q 'simple_lex.deca:[0-9]'; then
...
if test_lex src/test/deca/syntax/lexer/provided/chaine_incomplete.deca 2>&1 |
    grep -q -e 'chaine_incomplete.deca:10:'; then
